...
import (
	...
	"github.com/livepeer/clearinghouse/tenant-admin/internal/billingidentity"
)
...
func buildCustomerKey(tenantID, clientID, externalUserID string) (string, error) {
	return billingidentity.BuildCustomerKey(tenantID, clientID, externalUserID)
}
