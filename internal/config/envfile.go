...
// Remaining args are passed to Parse. The explicit return is true when --env-file was passed.
...
// Existing shell variables are not overwritten. When path is the default ".env"
// and the file is missing, loading is skipped silently.
